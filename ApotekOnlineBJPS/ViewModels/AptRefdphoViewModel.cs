...
{
    public partial class AptRefdphoViewModel
    {
        public AptRefdphoViewModel()
        {
            AptDatobats = new HashSet<AptDatobatViewModel>();
        }
        ...
        public virtual ICollection<AptDatobatViewModel> AptDatobats { get; set; }
    }
}

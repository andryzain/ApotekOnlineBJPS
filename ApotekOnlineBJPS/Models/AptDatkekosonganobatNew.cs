...
{
    public partial class AptDatkekosonganobatNew
    {
        [Key]
        public Guid AptDatkekosonganobatNewId { get; set; }
        ...
        public virtual AptRefalasankosongobat KdalasankosongNavigation { get; set; } = null!;
    }
}

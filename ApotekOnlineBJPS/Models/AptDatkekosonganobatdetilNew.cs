...
{
    public partial class AptDatkekosonganobatdetilNew
    {
        [Key]
        public Guid AptDatkekosonganobatdetilNewId { get; set; }
        ...
        public virtual AptDatkekosonganobatNew IdNavigation { get; set; } = null!;
    }
}

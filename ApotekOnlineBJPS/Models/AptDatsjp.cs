...
{
    public partial class AptDatsjp
    {
        public AptDatsjp()
        {
            AptDatreseps = new HashSet<AptDatresep>();
        }

        [Key]
        public Guid AptDatsjpId { get; set; }
        ...
        public virtual AptRefjnspelsjp JnspelsjpNavigation { get; set; } = null!;
        public virtual AptDatnofpk? NofpkNavigation { get; set; }
        public virtual ICollection<AptDatresep> AptDatreseps { get; set; }
    }
}
